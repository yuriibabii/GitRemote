...
namespace GitRemote.ViewModels.PopUp
{
    public class AssignedSelectPageViewModel : BindableBase
    {
        ...
        public AssignedSelectPageViewModel()
        {
            ...
            MessagingCenter.Subscribe<FilterManager>(this, SendManagerToFilterPage, OnSendManager);
        }
        ...
        {
            MessagingCenter.Unsubscribe<FilterManager>(this, SendManagerToFilterPage);
