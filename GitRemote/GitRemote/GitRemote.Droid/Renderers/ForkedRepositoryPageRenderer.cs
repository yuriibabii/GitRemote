...
[assembly: ExportRenderer(typeof(ForkedRepositoryPage), typeof(ForkedRepositoryPageRenderer))]
namespace GitRemote.Droid.Renderers
{
    public class ForkedRepositoryPageRenderer : TabbedPageRenderer
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<TabbedPage> e)
        {
            ...
            var page = e.NewElement as ForkedRepositoryPage;
            var viewModel = page?.BindingContext as ForkedRepositoryPageViewModel;
